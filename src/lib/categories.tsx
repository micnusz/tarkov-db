export const itemCategories = [
  { href: "/ammo", id: "ammo", name: "Ammunition" },
  {
    href: "/items/body-armor",
    id: "body-armor",
    name: "Body Armor",
  },
  { href: "/items/armor-plates", id: "armor-plates", name: "Armor Plates" },
  { href: "/items/backpacks", id: "backpacks", name: "Backpacks" },
