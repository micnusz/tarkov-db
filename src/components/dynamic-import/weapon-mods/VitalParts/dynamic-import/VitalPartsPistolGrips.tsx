...
const VitalPartsPistolGrips = () => {
  const { data: itemPistolGrips } = useSuspenseQuery({
    queryKey: ["vital-parts-pistol-grips"],
    queryFn: () => client.getPistolGrips(),
  });

  return (
    <div>
      <DataTableClient
        data={itemPistolGrips}
...
export default VitalPartsPistolGrips;
