...
const VitalPartsReceivers = () => {
  const { data: itemReceivers } = useSuspenseQuery({
    queryKey: ["vital-parts-receivers"],
    queryFn: () => client.getReceivers(),
  });
...
export default VitalPartsReceivers;
