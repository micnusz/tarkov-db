...
const componentsMap = {
  food: lazy(
    () =>
      import(
        "@/components/dynamic-import/provisions/dynamic-import/ProvisionsFood"
      )
  ),
  drinks: lazy(
    () =>
      import(
        "@/components/dynamic-import/provisions/dynamic-import/ProvisionsDrink"
      )
  ),
};

const ProvisionsClientPage = () => {
  const [selectedComponent, setSelectedComponent] =
    useState<keyof typeof componentsMap>("food");
...
export default ProvisionsClientPage;
